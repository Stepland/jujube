...
namespace MusicSelect {
    void ColorPanel::draw(Resources& resources, sf::RenderTarget& target, sf::FloatRect area) {
    ...
    void CategoryPanel::draw(Resources& resources, sf::RenderTarget& target, sf::FloatRect area) {
    ...
    void SongPanel::draw(Resources& resources, sf::RenderTarget& target, sf::FloatRect area) {
        if (m_song.cover) {
